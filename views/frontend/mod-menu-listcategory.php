...
$mod_menu_listcategory = category::where([['parent_id', '=', 0], ['status', '=', 1]])->orderBy('sort_order', 'ASC')->get();
...
<div class="dropdown list-category">
    ...
    <ul class="dropdown-menu w-100">
        <?php foreach ($mod_menu_listcategory as $rowcat) : ?>
            <li>
                <a class="dropdown-item" href="index.php?option=product&cat=<?php echo $rowcat->slug; ?>">
