...
--
-- Host: localhost:3306
-- Generation Time: Oct 23, 2023 at 02:55 PM
...
--
-- Database: `tadanganhduong_ltw`
--

-- --------------------------------------------------------

--
-- Table structure for table `0313_banner`
--

CREATE TABLE `0313_banner` (
...
--
-- Dumping data for table `0313_banner`
--

INSERT INTO `0313_banner` (`id`, `name`, `link`, `position`, `image`, `sort_order`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0313_brand`
--

CREATE TABLE `0313_brand` (
...
--
-- Dumping data for table `0313_brand`
--

INSERT INTO `0313_brand` (`id`, `name`, `slug`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0313_category`
--

CREATE TABLE `0313_category` (
  `id` int NOT NULL COMMENT 'Mã Loại',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tên loại SP',
  `slug` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'SLug Loại SP',
...
--
-- Dumping data for table `0313_category`
--

INSERT INTO `0313_category` (`id`, `name`, `slug`, `parent_id`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0313_contact`
--

CREATE TABLE `0313_contact` (
...
--
-- Table structure for table `0313_menu`
--

CREATE TABLE `0313_menu` (
...
--
-- Dumping data for table `0313_menu`
--

INSERT INTO `0313_menu` (`id`, `name`, `link`, `type`, `table_id`, `sort_order`, `position`, `level`, `parent_id`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0313_order`
--

CREATE TABLE `0313_order` (
...
--
-- Table structure for table `0313_orderdetail`
--

CREATE TABLE `0313_orderdetail` (
...
--
-- Table structure for table `0313_post`
--

CREATE TABLE `0313_post` (
...
--
-- Table structure for table `0313_product`
--

CREATE TABLE `0313_product` (
...
--
-- Dumping data for table `0313_product`
--

INSERT INTO `0313_product` (`id`, `category_id`, `brand_id`, `name`, `slug`, `image`, `detail`, `qty`, `price`, `pricesale`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0313_topic`
--

CREATE TABLE `0313_topic` (
...
--
-- Table structure for table `0313_user`
--

CREATE TABLE `0313_user` (
...
--
-- Dumping data for table `0313_user`
--

INSERT INTO `0313_user` (`id`, `name`, `username`, `password`, `email`, `gender`, `phone`, `image`, `roles`, `address`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Indexes for table `0313_banner`
--
ALTER TABLE `0313_banner`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_brand`
--
ALTER TABLE `0313_brand`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_category`
--
ALTER TABLE `0313_category`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_contact`
--
ALTER TABLE `0313_contact`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_menu`
--
ALTER TABLE `0313_menu`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_order`
--
ALTER TABLE `0313_order`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_orderdetail`
--
ALTER TABLE `0313_orderdetail`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_post`
--
ALTER TABLE `0313_post`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_product`
--
ALTER TABLE `0313_product`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_topic`
--
ALTER TABLE `0313_topic`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0313_user`
--
ALTER TABLE `0313_user`
  ADD PRIMARY KEY (`id`) USING BTREE;
