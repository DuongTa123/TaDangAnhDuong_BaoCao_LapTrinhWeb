    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 pt-4">
                ...
                <p class="pt-1">
                    Địa chỉ: 38 Tây Hòa, Phường Phước Long A, Quận 9, Thành Phố Hồ Chí Minh
                </p>
                <p class="pt-1">
                    Điện thoại: 0369964925(call, zalo) - Email: tadanganhduong@gmail.com
                </p>
...
<section class="dhl-copyright bg-dark py-3">
    <div class="container text-center text-white">
        Thiết kế bởi: Tạ Đặng Anh Dương - Phone: 0998765432
    </div>
</section>
</body>
